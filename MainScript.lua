...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		...
		suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/randombackup1293/PastewareModded/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
			...
			local teleportScript = [[
				...
				if shared.VapeDeveloper or shared.VoidDev then
					if isfile('vape/NewMainScript.lua') then
						...
						loadstring(game:HttpGet("https://raw.githubusercontent.com/randombackup1293/PastewareModded2/main/NewMainScript.lua", true))()
					end
				else
					loadstring(game:HttpGet("https://raw.githubusercontent.com/randombackup1293/PastewareModded2/main/NewMainScript.lua", true))()
				end
